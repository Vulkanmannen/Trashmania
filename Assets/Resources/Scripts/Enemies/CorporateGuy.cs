...
public class CorporateGuy : Enemy
{
	...
	protected override void animationFunc()
	{
		...
		{
			GetComponentInChildren<AnimationScript>().setAnimation(typeOfEnemy[typeOfEnemyIndex] * 2 + (int)AnimationMode.THROW, 15, true, 20);
		...
		{
			GetComponentInChildren<AnimationScript>().setAnimation(typeOfEnemy[typeOfEnemyIndex] * 2 + (int)AnimationMode.TOTHROW, 15, true, 30, true);
	...
	protected override void move()
	{
		...
		{
			GetComponentInChildren<AnimationScript>().setAnimation(typeOfEnemy[typeOfEnemyIndex] * 2 + (int)AnimationMode.TOTHROW, 15, false, 30);
			animationMode = AnimationMode.TOTHROW;
		}
	}
